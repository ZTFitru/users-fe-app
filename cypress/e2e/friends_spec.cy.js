describe('login spec', () => {
  beforeEach(() => {
    ...
    cy.intercept(
      ...
      { statusCode: 200, fixture: 'delete_friend' }
  ...
  it('Load friends view', () => {
    ...
    cy.get('.friends-list-container .user-card-wrapper:nth-child(2)').should(
      'contain',
      'joe'
    );
  });

  it('Removes a friend on user click', () => {
